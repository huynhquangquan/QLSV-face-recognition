...
('Admin', 'admin', '$2a$12$mrG9TVc6B/IFb2oYVWOGE..t7j9qj0iNa8SEZ90LhhJvrW1D5IeN.', 'Admin', 1, 'admin@gmail.com'),
('Huỳnh Quang Quân', 'quan', '$2a$12$IoeLhYO46AlJsf3bA3ZOze0hQ1ARoTzPEgK61Z00hrKCs3N81C6yi', 'Nhân viên xuất', 1, 'quangquanhuynh@gmail.com'),
('Lê Huỳnh Trúc Vy', 'vy', '$2a$12$OMIn/gCnSzRE1F1iLAtQG.MLI5qPeGmagnXRG6ZkTmjr5RO4JVuOW', 'Nhân viên nhập', 1, 'trucvy@gmail.com'),
('Trần Lê Đăng Khoa', 'khoa', '$2a$12$Gj77PvxCeHSnIHQV4b8ewO7zwXkznsxluOpM.U3a/sx4zi2SUWg8K', 'Quản lý kho', 1, 'dangkhoa@gmail.com');
...
('PN31', '2022-12-15 23:14:59', 'admin', 'ANPHAT', 58370000),
('PN32', '2022-12-16 02:19:27', 'admin', 'HOANGPHAT', 80260000),
('PN33', '2022-12-16 13:09:45', 'admin', 'VIETSTARS', 68070000),
